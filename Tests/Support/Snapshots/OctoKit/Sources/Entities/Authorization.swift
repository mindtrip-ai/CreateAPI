...
public struct Authorization: Codable {
    ...
    public init(id: Int, url: URL, scopes: [String], token: String, tokenLastEight: String, hashedToken: String, app: App, note: String, noteURL: URL, updatedAt: Date, createdAt: Date, fingerprint: String, user: SimpleUser? = nil, installation: ScopedInstallation? = nil, expiresAt: Date) {
        self.id = id
        self.url = url
        self.scopes = scopes
        self.token = token
