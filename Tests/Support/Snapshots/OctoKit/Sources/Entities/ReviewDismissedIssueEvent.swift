...
public struct ReviewDismissedIssueEvent: Codable {
    ...
    public init(id: Int, nodeID: String, url: String, actor: SimpleUser, event: String, commitID: String, commitURL: String, createdAt: String, performedViaGithubApp: Integration, dismissedReview: DismissedReview) {
        self.id = id
        self.nodeID = nodeID
        self.url = url
        self.actor = actor
