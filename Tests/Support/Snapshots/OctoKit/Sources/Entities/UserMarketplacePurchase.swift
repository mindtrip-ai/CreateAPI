...
public struct UserMarketplacePurchase: Codable {
    ...
    public init(billingCycle: String, nextBillingDate: Date, unitCount: Int, isOnFreeTrial: Bool, freeTrialEndsOn: Date, updatedAt: Date, account: MarketplaceAccount, plan: MarketplaceListingPlan) {
