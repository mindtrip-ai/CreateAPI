...
public struct TimelineUnassignedIssueEvent: Codable {
    ...
    public init(id: Int, nodeID: String, url: String, actor: SimpleUser, event: String, commitID: String, commitURL: String, createdAt: String, performedViaGithubApp: Integration, assignee: SimpleUser) {
        self.id = id
        self.nodeID = nodeID
        self.url = url
        self.actor = actor
