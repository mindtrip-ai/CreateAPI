...
public struct SimpleCommitStatus: Codable {
    ...
    public init(description: String, id: Int, nodeID: String, state: String, context: String, targetURL: URL, isRequired: Bool? = nil, avatarURL: URL, url: URL, createdAt: Date, updatedAt: Date) {
