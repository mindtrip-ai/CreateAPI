...
public struct RenamedIssueEvent: Codable {
    ...
    public init(id: Int, nodeID: String, url: String, actor: SimpleUser, event: String, commitID: String, commitURL: String, createdAt: String, performedViaGithubApp: Integration, rename: Rename) {
        self.id = id
        self.nodeID = nodeID
        self.url = url
        self.actor = actor
