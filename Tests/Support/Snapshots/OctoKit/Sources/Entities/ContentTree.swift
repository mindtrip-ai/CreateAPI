...
public struct ContentTree: Codable {
    ...
    public init(type: String, size: Int, name: String, path: String, sha: String, url: URL, gitURL: URL, htmlURL: URL, downloadURL: URL, entries: [Entry]? = nil, links: Links, content: AnyJSON, encoding: AnyJSON) {
        self.type = type
        self.size = size
        self.name = name
        self.path = path
